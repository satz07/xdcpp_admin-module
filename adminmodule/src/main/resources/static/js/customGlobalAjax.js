...
sendAjaxRequestForEdit(countryid)
	...
	$.ajax({
            ...
            url: "/api/global/getglobalcurrencyCode/"+selectedCountry,
...
function sendAjaxRequestForEdit(selectedCountry) {
	...
	$.ajax({
            type: "GET",
            contentType: "application/json",
            url: "/getglobalcurrencycodebyIdapi/"+selectedCountry,
...
$(document).ready(function() {
	...
	$.ajax({
            type: "GET",
            contentType: "application/json",
            url: "/api/global/getglobalPaymentCode/"+selectedCountry+"/"+userType,
...
$(document).ready(function() {
    ...
    $("#receiveCountryCode").change(function() {
	 // alert("alert")
        sendRecieveGlobalAjaxRecRequest();
    });
    
     function sendRecieveGlobalAjaxRecRequest() {
	 var selectedCountry = $("#receiveCountryCode").val();
         var userType;
         if(document.getElementById('business').checked) {
             //Male radio button is checked
	...
	$.ajax({
            type: "GET",
            contentType: "application/json",
            url: "/api/global/getglobalRecieveCode/"+selectedCountry+"/"+userType,
...
function redBusiness() {
    ...
    if (selectedCountry != "" && selectedRecCountry != "") {
        ...
        $.ajax({
            type: "GET",
            contentType: "application/json",
            url: "/api/global/getglobalcurrencyCode/"+selectedRecCountry,
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $(".selectpicker").selectpicker();
                var globPaymentCodeId=null;
                data.forEach(function(item, i) {
                    console.log(item.paymentCodeMaster);
                    option += "<option value = " + item.id+ ">" + item.paymentCodeMaster  + " - " +item.description+"</option>";
                    globPaymentCodeId=item.id;
                });
                $("#paymentCode").html(option);
                $('.selectpicker').selectpicker('refresh');
                // $('#paymentCode').val(globPaymentCodeId);
                // $('#paymentCode').selectpicker('render');
            },
            error: function (e) {
                console.log("ERROR : ", e);
        ...
        $.ajax({
            type: "GET",
            contentType: "application/json",
            url: "/api/global/getglobalRecieveCode/"+selectedRecCountry+"/"+userType,
            ...
            success: function (data) {
                ...
                $(".selectpicker").selectpicker();
                var globReceiveCodeId=null;
                data.forEach(function(item, i) {
                    console.log(item.paymentCodeMaster);
                    option += "<option value = " + item.id+ ">" + item.paymentCodeMaster  + " - " +item.description+"</option>";
                    globReceiveCodeId=item.id;
                });
                $("#receiveCode").html(option);
                $('.selectpicker').selectpicker('refresh');
                // $("#receiveCode").val(globReceiveCodeId);
                // $("#receiveCode").selectpicker('render');
            },
            error: function (e) {
                console.log("ERROR : ", e);
